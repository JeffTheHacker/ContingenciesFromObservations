...
class ESPRollout(NumpyableTensorGroup):
    ...
    def __init__(self, S_car_frames_list, Z_list, m_list, mu_list, sigma_list, sigel_list, metadata_list, phi):
        ...
        # self.S_world_frame = tf.identity(self.S_car_frames,name = 'S_world_frame')
        self.S_grid_frame = tf.identity(self.S_car_frames,name = 'S_grid_frame')
...
class ESPPhi(NumpyableTensorGroup):
    ...
    def __init__(self,
        ...
        # self.S_past_car_frames = tf.identity(self.S_past_world_frame) # my mod
        # self.S_past_car_frames_noisy = tf.identity(self.S_past_world_frame_noisy) # my mod
        # (B, A, T, D)
        ...
        self.S_past_grid_frame = tf.identity(self.S_past_car_frames) # my mod
        self.S_past_grid_frame_noisy = tf.identity(self.S_past_car_frames_noisy) # my mod
    ...
    def update_frames(self, S_t_car_frames, S_tm1_car_frames):
        ...
        #S_t_world_frame = tf.identity(S_t_car_frames) # my mod
        ...
        #velocity_in_world_frame = tf.identity(velocity_in_car_frame) # my mod
...
class ESPTrainingInput(NumpyableTensorGroupGroup):
    ...
    def from_data(cls, S_past_world_frame, yaws, overhead_features, agent_presence, S_future_world_frame, feature_pixels_per_meter,
        ...
        # S_future_car_frames = tf.identity(S_future_world_frame) # my mod
        S_future_grid_frame = tf.identity(S_future_car_frames) # my mod
